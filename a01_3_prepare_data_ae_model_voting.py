...
if __name__ == '__main__':
    ...
    for subset in subsets:
        ...
        # for loop that goes through all voter models
        model_numbers = [0, 1, 2]
        for model_number in model_numbers:
            model_name = 'simplecnn' #'mobilenetv3_small_100' #overfittingcnn
            save_path_best = os.path.join(config["logging_params"]["save_dir"], f'{model_name}_classifier_raw_best_{model_number}.pth')
            model = load_model(model_name, NUM_CLASSES, save_path_best, DEVICE)
