...
if os.path.exists(vae_model_path):
    ...
    train_vae(vae_model, train_loader, optimizer, num_epochs=num_epochs, beta=beta)
    torch.save(vae_model.state_dict(), vae_model_path)

latents, labels, measurement_noise, mislabeled = get_latent_vectors(vae_model, train_loader)
